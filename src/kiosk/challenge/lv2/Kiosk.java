...
import kiosk.challenge.lv2.menus.burger.Burger;
import kiosk.challenge.lv2.menus.dessert.Dessert;
import kiosk.challenge.lv2.menus.drink.Drink;
...
public class Kiosk {
    ...
    private void removeItemList() {
        shoppingCart.getCart().removeAll(menuItems);
    }
